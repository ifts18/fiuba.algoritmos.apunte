...
llame al {\it método} \lstinline!upper! del objeto \lstinline!cadena!.
...
archivos}, etc.  Cada uno de estos tipos tiene sus características, tiene
...
suficiente con definir el método |__lt__| ({\it less than}), que corresponde al
