...
\ejercicio{Escribir funciones que dada una cadena de caracteres:}
\begin{partes}
...
\ejercicio{Escribir funciones que dada una cadena y un caracter:}
\begin{partes}
...
\ejercicio{Modificar las funciones anteriores, para que reciban un parámetro que indique
la cantidad máxima de reemplazos o inserciones a realizar.}


\ejercicio{Escribir una función que reciba una cadena que contiene un largo número entero y
...
\ejercicio{Escribir una función que dada una cadena de caracteres, devuelva:}
\begin{partes}
...
\ejercicio{Escribir funciones que dadas dos cadenas de caracteres:}
\begin{partes}
...
\ejercicio{Escribir una función que reciba una cadena de unos y ceros (es decir, un
