...
Una {\it pila} es un TAD que tiene las siguientes operaciones:
...
trabajando sobre una lista: solamente podremos usar los métodos de la {\it
interfaz pila}.
\end{atencion}
...
la lista como borrar al comienzo de la lista de Python {\it consumen tiempo
...
El TAD {\it cola} modela el comportamiento: ``el primero que llega
es el primero en ser atendido''; los demás elementos se van {\it encolando} hasta que
les toque su turno.
