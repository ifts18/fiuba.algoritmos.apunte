...
\ejercicio{Escribir dos funciones que permitan calcular:}
\begin{partes}
    \item La cantidad de segundos en un tiempo dado en horas, minutos y segundos.
    \item La cantidad de horas, minutos y segundos de un tiempo dado en segundos. 
\end{partes}

\ejercicio{Usando las funciones del ejercicio anterior, escribir un programa que lea
de teclado dos tiempos expresados en horas, minutos y segundos; las sume y
muestre el resultado en horas, minutos y segundos por pantalla.}

\ejercicio{Escribir una función que dados cuatro números, devuelva el mayor
...
\ejercicio{\bf Área de un triángulo en base a sus puntos}
\begin{partes}
