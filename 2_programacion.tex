...
\ejercicioc{Escribir un ciclo definido para imprimir por pantalla
todos los números entre 10 y 20.}

\ejercicioc{Escribir un ciclo definido que salude por pantalla a
sus cinco mejores amigos/as.}

\ejercicioc{Escribir un programa que use un ciclo definido con
