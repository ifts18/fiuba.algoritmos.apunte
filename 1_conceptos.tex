...
\ejercicio{Correr tres veces el programa \lstinline!cuad! con valores
de entrada (3,5), (3,3) y (5,3) respectivamente. ¿Qué sucede en
cada caso?}

\ejercicio{Insertar instrucciones de depuración que permitan ver el valor
...
\ejercicio{La salida del programa \lstinline!cuad! es poco
informativa. Escribir un programa \lstinline!nom_cuad! que ponga el
número junto a su cuadrado. Ejecutar el programa nuevo.}

\ejercicio{Si la salida sigue siendo poco informativa seguir mejorándola hasta
que sea lo suficientemente clara.}

\ejercicio{Escribir un programa que pregunte al usuario:}
\begin{partes}
  \item su nombre, y luego lo salude.
  \item dos números y luego muestre el producto.
\end{partes}

\ejercicio{Implementar algoritmos que permitan:}
\begin{partes}
...
\ejercicio{Mostrar el resultado de ejecutar estos bloques de código en el intérprete de python:}
\begin{partes}
\item \begin{verbatim}
>>> for i in range(5):
        print i * i
...
\ejercicio{Implementar algoritmos que resuelvan los siguientes problemas:}
\begin{partes}
...
\ejercicio{Escribir un programa que le pida una palabra al usuario, para luego 
