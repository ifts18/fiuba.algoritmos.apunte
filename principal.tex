...
\newenvironment{sabias_que}
 {\begin{lrbox}{\temporalbox}\begin{minipage}{0.95\textwidth}
  ...
  \begin{minipage}{0.80\textwidth}\bf Sabías que\ldots\end{minipage}\\[0.5\baselineskip]
  \begin{small}}
 {\end{small}\end{minipage}\end{lrbox}
  \begin{figure*}[ht]
  \centering
  \fboxsep 0.5em
  \fcolorbox{black}{verde}{
  \usebox{\temporalbox}}
  \end{figure*}}
...
\newenvironment{atencion}
 {\begin{lrbox}{\temporalbox}\begin{minipage}{0.95\textwidth}
  ...
  \begin{minipage}{0.80\textwidth}\bf Atención \end{minipage}\vspace{0.8ex}\\[0.5\baselineskip]
  \begin{small}}
 {\end{small}\end{minipage}\end{lrbox}
  \begin{figure*}[ht]
  \centering
...
\lstnewenvironment{codigo-python}{\lstset{moredelim=**[is][\bfseries]{(@}{@)},escapeinside={(~}{~)}}}{}
\lstnewenvironment{codigo-python-sn}{\lstset{numbers=none,moredelim=**[is][\bfseries]{(@}{@)},escapeinside={(~}{~)}}}{}
\lstnewenvironment{codigo-python-sn-small}{\lstset{numbers=none,basicstyle=\footnotesize\ttfamily,moredelim=**[is][\bfseries]{(@}{@)},escapeinside={(~}{~)}}}{}
\lstnewenvironment{codigo-nohl}{\lstset{language={},moredelim=**[is][\bfseries]{(@}{@)},escapeinside={(~}{~)}}}{}
\lstnewenvironment{codigo-nohl-sn}{\lstset{language={},numbers=none,moredelim=**[is][\bfseries]{(@}{@)},escapeinside={(~}{~)}}}{}
