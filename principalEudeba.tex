...
\setlength{\pdfpagewidth}{15.7cm}
\setlength{\pdfpageheight}{23cm}
...
%Esto se sacó para agregar Eudeba:
...
%Hasta acá se sacó todo por Eudeba
...
%    basicstyle=\small, 
%	stringstyle=\ttfamily % print whole listing small
%}
    basicstyle=\ttfamily}
%    basicstyle=\ttfamily\normalsize,
...
\hypersetup{%
	linkcolor=black,
	urlcolor=blue,
	pdftitle={Algoritmos y Programación I - Con lenguaje Python},
	bookmarksnumbered,
}%
\usepackage{hypcap}

\setlength{\footmarkwidth}{1.5em} % if your footnotes go into the
%hundreds, you need at least 1.7em \setlength{\footmarksep}{0em}
\footmarkstyle{#1.\hfill} % this will give you plain numbers for your
%notes
\pagestyle{plain} \traditionalparskip
\chapterstyle{default}\raggedbottom

\clubpenalty=100000 \widowpenalty=100000

% La caja de Eudeba
%\setstocksize{297mm}{210mm} %el tamaÃ±o del papel A4
\setstocksize{23cm}{15.7cm} %el tamaÃ±o del papel
\settrimmedsize{23cm}{15.7cm}{*} %el tamaÃ±o del papel recortado
\settypeblocksize{18.5cm}{11.7cm}{*} %el tamaÃ±o de la caja
\setulmargins{2.6cm}{*}{*} % márgenes superior e inferior
%\setlength{\topmargin}{0in}
\setlrmargins{2cm}{*}{*} % margen izquierdo de las páginas
\setlength{\footskip}{24pt} \checkandfixthelayout
